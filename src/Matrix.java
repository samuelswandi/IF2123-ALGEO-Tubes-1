...
public class Matrix {
    ...
    void SPLInverse() {
        ...
        if (this.rows != this.columns - 1) {
            System.out.println(
                    "Dibutuhkan " + (this.columns - 1) + " persamaan untuk " + (this.columns - 1) + " buah variabel!");
        } else {
            int i, j, row = 0;
    ...
    void gaussMultipleSolution() {
        ...
        /*
         * F.S. = Tercetak solusi penyelesaian variabel x1,x2,...,xN dengan N =
         * matrix.rows, menggunakan pendekatan parametrik dengan batasan alfabet (p - z)
         * [ASCII 112 - 122]
         */
        ...
        for (int i = 0; i < this.rows; ++i) {
            if (!allZero[i]) {
                ...
                result[nonZero] = (this.matrix[i][this.columns - 1] != 0 ? ((this.matrix[i][this.columns - 1]) + " ")
                        : "0.0 ");
    ...
    int CheckMatrix() {
        ...
        /*
         * F.S. = Tercetak solusi apakah matriks memiliki satu unik, banyak, atau tidak
         * ada solusi 0 = Satu solusi yang unik 1 = Banyak solusi 2 = Tidak ada solusi
         */
        boolean temp = true;
        for (int j = 0; j < this.columns; j++) {
    ...
    void AddIdentity() {
        /* I.S. = Matrix Square terdefinisi */
        /*
         * F.S. = Ditambahkan matrix identitas berukuran (n x n) --> untuk keperluan
         * Inverse metode Gauss-Jordan
         */
    ...
    void DelIdentity() {
         ...
         */
        /*
         * F.S. = Terbentuk matrix (n x n) setelah matrix identitas sebelah kiri
         * terhapus
         */
    ...
    int ArgMax(int h, int k) {
        /*
         * Menghasilkan Index dari nilai absolute terbesar dari kolom k suatu matriks
         * mulai dari kolom h hingga matrix.rows - 1
         */
    ...
    String Interpolation(double x) {
        /*
         * Menghasilkan persamaan dan taksiran nilai dari suatu persamaan yang dicari
         * melalui beberapa titik dengan x nilai yang dicari
         */
        /*
         * I.S. = titik-titik pembentuk persamaan didefinisikan dalam bentuk matrix
         * berukuran sesuai banyaknya titik
         */
        /*
    ...
    String MultipleLinearReg() {
         ...
         */
        /*
         * I.S. = data-data pembentuk persamaan didefinisikan dalam bentuk matrix
         * berukuran sesuai banyaknya data
         */
        /*
         * F.S = didapat persamaan dari semua data yang diketahui dan taksiran dari data
         * dengan memasukkan data yang ingin dicari taksirannya
         */
